...
#define GTMSESSION_DEPRECATE_ON_2018_SDKS(_MSG) __attribute__((deprecated("" _MSG)))
#else
#define GTMSESSION_DEPRECATE_ON_2018_SDKS(_MSG)
#endif
...
@property(atomic, readonly, GTM_NULLABLE) NSMutableURLRequest *mutableRequest
    GTMSESSION_DEPRECATE_ON_2018_SDKS("use 'request' or '-setRequestValue:forHTTPHeaderField:'");
